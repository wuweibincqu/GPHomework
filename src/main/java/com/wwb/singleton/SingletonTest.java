...
public class SingletonTest {
	...
	public void testHungrySingleton() {
		...
		System.out.println(instance1);//com.wwb.singleton.HungrySingleton@22927a81
		System.out.println(instance2);//com.wwb.singleton.HungrySingleton@22927a81
	...
	public void testSeriableSingleton() {
		...
		try {
			...
			//没加readReslove方法
			/*System.out.println(singleton1);//com.wwb.singleton.SeriableSingleton@5680a178
			System.out.println(singleton2);//com.wwb.singleton.SeriableSingleton@61e4705b
			System.out.println(singleton1 == singleton2);//false*/

			//添加了readReslove方法
			System.out.println(singleton1);//com.wwb.singleton.SeriableSingleton@61e4705b
			System.out.println(singleton2);//com.wwb.singleton.SeriableSingleton@61e4705b
